function createNewElement(tagName){
    ...
    var foodOptionsList = ["North Indian","South Indian","Chinese","Japanese","Sea Food"]
    ...
    var stateOptionsList = ["Choose...","Uttar Pradesh","Uttarakhand","Tamil Nadu","Kerala","Karnataka","Andhra Pradesh","Telangana"]
    ...
    var countryOptionsList = ["Choose...","India","China","Japan","Nepal","Singapore"]
